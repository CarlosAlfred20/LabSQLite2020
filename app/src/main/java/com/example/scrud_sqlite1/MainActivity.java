...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setSubtitle("Carlos Alfredo Alvarez Lopez");
...
/*
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.one){
            ...
            Intent listViewActivity = new Intent(MainActivity.this, consulta.class);
            startActivity(listViewActivity);
...
private void comfirmacion(){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent spinnerAct = new Intent(MainActivity.this,consulta.class);
        ...
        if (inputET && inputED && input1){
            try {
                ...
                if (conexion.InsertTradicional(dato)){
                    ...
                    Toast.makeText(this,"Ya existen los datos"+et_codigo1.getText().toString(),Toast.LENGTH_LONG).show();
                }
            }catch (Exception o){
